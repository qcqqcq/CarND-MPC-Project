...
Latency was dealt with by first deciding a latency time period. Various values were tried.  Then the state was predicting into the future to create the new state.  The new state then goes into the solver
